...
| Private access | Headscale, embedded DERP/STUN, Caddy TLS termination, private routes, and bastion NAT | `deploy network` |
...
| Traffic and TLS | Gateway API CRDs, public/admin Gateways, cert-manager, Hetzner DNS webhook, ClusterIssuers, Hetzner CCM/CSI, and MetalLB | `deploy cluster`, `deploy tls` |
