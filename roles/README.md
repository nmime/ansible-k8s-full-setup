...
This directory contains 13 Ansible roles for each platform component:
...
| `k8s-cluster-management/` | Kubernetes cluster installation | Kubespray, Cilium, Gateway API, cert-manager, MetalLB, Hetzner CCM/CSI | K8s v1.34.3, Cilium v1.19.2, cert-manager v1.20.0, MetalLB v0.15.3, CCM v1.30.1, CSI v2.20.0 |
...
| `gitlab-selfhosted/` | GitLab EE (Ultimate) with auto-license | Helm, GitLab Runner, gitlab-license gem | EE v18.10.0, Chart 9.10.0, Runner 0.87.0 |
| `k8s-gitops/` | GitOps continuous delivery | ArgoCD, ApplicationSets | ArgoCD v3.3.4, Chart 9.4.15 |
